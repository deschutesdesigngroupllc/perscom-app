<div class="dv-flex dv-flex-col">
    <div class="dv-overflow-x-auto">
        <div class="dv-inline-block dv-min-w-full dv-align-middle">
            <div class="dv-overflow-hidden dv-rounded-lg">
...
<style>
    ...
    *, ::before, ::after {
    ...
    .dv-divide-y > :not([hidden]) ~ :not([hidden]) {
        --tw-divide-y-reverse: 0;
        border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse)));
        border-bottom-width: calc(1px * var(--tw-divide-y-reverse));
    }

    .dv-divide-gray-100 > :not([hidden]) ~ :not([hidden]) {
        --tw-divide-opacity: 1;
        border-color: rgb(243 244 246 / var(--tw-divide-opacity));
    }

    .dv-divide-gray-200 > :not([hidden]) ~ :not([hidden]) {
        --tw-divide-opacity: 1;
