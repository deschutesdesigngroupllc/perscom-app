...
export function Hero() {
    return (
          ...
          <span className="relative">personnel management</span>
        </span>{' '} tools for para-military organizations.
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
                We've built the tools you've always been looking for. Specifically catered to para-military organizations, but fully customizable to support any organization.
            </p>
            <div className="mt-10 flex justify-center space-x-6">
                ...
                <ButtonLink href="mailto:sales@deschutesdesigngroup.com" variant="outline">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
