...
export function Hero() {
  return (
    <section id='hero'>
      <Container className='lg:py-20 py-16 mb-8 text-center'>
        <h1 className='mx-auto max-w-6xl font-extrabold tracking-tight prose text-3xl sm:text-5xl md:text-6xl lg:text-7xl'>
