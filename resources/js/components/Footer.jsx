    ...
    <footer>
      <Container>
        <div className='flex flex-col items-center py-16'>
          ...
          <nav className='mt-10' aria-label='quick links'>
            <ul className='-my-1 flex flex-wrap justify-center space-x-6'>
              ...
              <li>
                <a href={route('web.privacy-policy.index')} className='prose rounded-lg px-2 py-1 text-sm hover:bg-gray-200'>
                  {' '}
                  Privacy Policy{' '}
                </a>
              </li>
        ...
        <div className='flex flex-col items-center border-t border-gray-400/10 py-10'>
          <p className='prose mt-6 text-center text-sm sm:mt-0'>
