      ...
      {append ? (
        <div className='mt-1 flex rounded-md shadow-sm'>
          <input
            ...
            type={type}
            {...props}
            className='block w-full appearance-none rounded-none rounded-l-md border border-gray-200 bg-gray-50 px-3 py-2 placeholder-gray-400 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-blue-500 sm:text-sm'
          />
