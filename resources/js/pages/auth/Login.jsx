    ...
    <AuthLayout>
      ...
      {demoMode && (
        <div className='mb-4'>
          ...
          <div className='text-sm text-gray-600'>Use the login information below to get started.</div>
        </div>
      )}
      ...
      <form onSubmit={submit} className='space-y-6'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='text-sm'>
            {canResetPassword && (
              <Link href={route('password.request')} className='text-sm text-gray-600 underline hover:text-gray-800'>
                {' '}
