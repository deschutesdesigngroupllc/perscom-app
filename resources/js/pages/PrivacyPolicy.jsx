...
function PrivacyPolicy() {
  return (
    <>
      <Header />
      <Container className='lg:pt-26 pt-20 pb-16 text-slate-600 flex flex-col space-y-4'>
        <h1 className='font-bold h1 text-3xl mb-3 text-black'>PERSCOM.io Privacy Policy</h1>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Information We Collect</h3>
        <p>
        ...
        <p>
          &ldquo;Voluntarily provided&rdquo; information refers to any information you knowingly and actively provide us when using or
        ...
        <h4 className='font-bold text-black text-xl'>Personal Information</h4>
        <p>
        ...
        <h4 className='font-bold text-black text-xl'>User-Generated Content</h4>
        <p>
        ...
        <h4 className='font-bold text-black text-xl'>Transaction Data</h4>
        <p>
        ...
        <h4 className='font-bold text-black text-xl'>Collection and Use of Information</h4>
        ...
        <h4 className='font-bold text-black text-xl'>Security of Your Personal Information</h4>
        <p>
        ...
        <h4 className='font-bold text-black text-xl'>How Long We Keep Your Personal Information</h4>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Children’s Privacy</h3>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Disclosure of Personal Information to Third Parties</h3>
        ...
        <ul className='list-disc list-inside'>
          ...
          <li>
            ...
            service providers, data storage, hosting and server providers, error loggers, debt collectors, maintenance or problem-solving
        ...
        <h3 className='font-bold text-black text-2xl'>Your Rights and Controlling Your Personal Information</h3>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Use of Cookies</h3>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Business Transfers</h3>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Limits of Our Policy</h3>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Changes to This Policy</h3>
        <p>
        ...
        <h3 className='font-bold text-black text-2xl'>Contact Us</h3>
        <p>For any questions or concerns regarding your privacy, you may contact us using the following details: </p>
        <p>
          Deschutes Design Group LLC
          <br />
          <a className='underline' href='https://www.deschutesdesigngroup.com'>
