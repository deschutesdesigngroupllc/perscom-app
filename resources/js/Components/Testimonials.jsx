                            ...
                            <ul className="space-y-6 sm:space-y-8">
                                {column.map((testimonial, testimonialIndex) => (
                                    <li key={testimonialIndex}>
                                        <figure className="bg-white shadow-slate-900/10 relative rounded-2xl p-6 shadow-xl">
                                            <svg
                                                aria-hidden="true"
                                                width={105}
                                                height={78}
                                                className="fill-slate-100 absolute top-6 left-6"
                                            >
                                            ...
                                            <figcaption className="border-slate-100 relative mt-6 flex items-center justify-between border-t pt-6">
                                                <div>
                                                    <div className="text-slate-900 font-display text-base">
                                                ...
                                                <div className="bg-slate-50 h-14 w-14 overflow-hidden rounded-full">
