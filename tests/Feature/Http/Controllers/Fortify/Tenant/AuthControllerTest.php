...
class AuthControllerTest extends TestCase
{
    ...
    public function test_can_login()
    {
        ...
        $this->post($this->tenant->url.'/login', [
    ...
    public function test_can_logout()
    {
        ...
        $this->post($this->tenant->url.'/logout')
             ->assertRedirect($this->tenant->url);
    ...
    public function test_verify_email_page_can_be_reached()
    {
        ...
        $this->get($this->tenant->url.'/email/verify')
             ->assertInertia(function (AssertableInertia $page) {
    ...
    public function test_can_send_email_verification_notification()
    {
        ...
        $this->post($this->tenant->url.'/email/verification-notification')
             ->assertRedirect()
             ->assertSessionHasNoErrors()
    ...
    public function test_verify_email_success_page_can_be_reached()
    {
        ...
        $this->get($this->tenant->url.'/email/verify/'.Str::random().'/'.Str::random())
             ->assertRedirect();
    ...
    public function test_can_send_forgot_password_notification_and_reach_reset_password_page()
    {
        ...
        $this->post($this->tenant->url.'/forgot-password', [
            'email' => $this->user->email,
        ])
             ->assertRedirect()
             ->assertSessionHasNoErrors()
