...
class AwardRecordPromptsTest extends TenantTestCase
{
    ...
    public function test_created_headline_prompt_string_is_properly_substituted()
    {
        ...
        $this->assertStringContainsString($record->award->name, $prompt);
        $this->assertStringContainsString($record->award->description, $prompt);
    }
