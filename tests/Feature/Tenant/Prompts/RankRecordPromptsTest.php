...
class RankRecordPromptsTest extends TenantTestCase
{
    ...
    public function test_created_headline_prompt_string_is_properly_substituted()
    {
        ...
        $this->assertStringContainsString($record->rank->name, $prompt);
        $this->assertStringContainsString($record->rank->description, $prompt);
    }
