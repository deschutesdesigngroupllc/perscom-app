...
{
    public function test_tag_for_model_is_correctly_generated()
    {
    ...
    public function test_cache_tag_is_correctly_generated()
    {
        $rank = Rank::factory()->createQuietly();
    ...
    public function test_surrogate_keys_are_correctly_generated()
    {
        ...
        $rank->each(function (Rank $rank) use ($keys) {
