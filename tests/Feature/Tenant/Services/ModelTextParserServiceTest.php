...
class ModelTextParserServiceTest extends TenantTestCase
{
    ...
    public function test_it_correctly_replaces_assignment_record_text()
    {
    ...
    public function test_it_correctly_replaces_award_record_text()
    {
    ...
    public function test_it_correctly_replaces_combat_record_text()
    {
    ...
    public function test_it_correctly_replaces_qualification_record_text()
    {
    ...
    public function test_it_correctly_replaces_rank_record_text()
    {
    ...
    public function test_it_correctly_replaces_service_record_text()
    {
    ...
    public function test_it_correctly_replaces_author_text()
    {
