...
class DemoRequestTest extends TestCase
{
    ...
    {
        config()->set('app.demo_tenant_host', $this->faker->domainWord.config('app.base_url'));
        config()->set('app.demo_tenant_id', $this->faker->randomDigitNot($this->tenant->getTenantKey()));
