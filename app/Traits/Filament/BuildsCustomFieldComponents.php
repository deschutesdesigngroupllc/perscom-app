...
trait BuildsCustomFieldComponents
{
    public static function buildCustomFieldInputs(Collection $fields): array
    {
        ...
        return $fields->map(fn (FieldModel $field): FieldComponent => $field->type->getFilamentField('data.'.$field->key, $field))->toArray();
    }
    ...
    public static function buildCustomFieldEntries(Collection $fields): array
    {
        ...
        return $fields->map(fn (FieldModel $field): FieldEntry => $field->type->getFilamentEntry($field->key, $field))->toArray();
    }
}
