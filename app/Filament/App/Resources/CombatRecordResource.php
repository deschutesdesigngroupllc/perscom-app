...
class CombatRecordResource extends BaseResource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Combat Record Information')
                    ->columns()
                    ->schema([
        ...
        return $infolist
            ->schema([
                Infolists\Components\Tabs::make()
                    ->columnSpanFull()
                    ->tabs([
                        Infolists\Components\Tabs\Tab::make('Combat Record')
                        ...
                        Infolists\Components\Tabs\Tab::make('Document')
                            ...
                            ->schema([
                                Infolists\Components\Livewire::make(ViewDocument::class, fn (?CombatRecord $record) => [
    ...
    {
        return [
            'index' => Pages\ListCombatRecords::route('/'),
            'create' => Pages\CreateCombatRecord::route('/create'),
            'view' => Pages\ViewCombatRecord::route('/{record}'),
            'edit' => Pages\EditCombatRecord::route('/{record}/edit'),
        ];
    }
