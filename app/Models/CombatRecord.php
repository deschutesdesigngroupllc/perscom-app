 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder|CombatRecord author($user)
 * @method static \Illuminate\Database\Eloquent\Builder|CombatRecord document($document)
