...
class ContentTagParserService
{
    ...
    protected function resolveTag(string $tag, ?User $user = null, ?Model $attachedModel = null): mixed
    {
        ...
        return value(match (true) {
            ...
            $tag === '{user_email_verified_at}' => data_get($user, 'email_verified_at') ? Date::parse($user?->email_verified_at)->toDayDateTimeString() : null,
            ...
            $tag === '{assignment_record_type}' => ($attachedModel->type ?? null)?->getLabel() ?? null,
