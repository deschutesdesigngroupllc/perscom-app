...
class QualificationRecordsPolicy
{
    ...
    {
        return $user->hasPermissionTo('create:qualificationrecord', 'web') || $user->tokenCan('create:qualificationrecord');
    }
    ...
    {
        return $user->hasPermissionTo('update:qualificationrecord', 'web') || $user->tokenCan('update:qualificationrecord');
    }
    ...
    {
        return $user->hasPermissionTo('delete:qualificationrecord', 'web') || $user->tokenCan('delete:qualificationrecord');
    }
