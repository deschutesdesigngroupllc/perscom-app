...
class NewCombatRecord extends Notification implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(Combat $record)
    {
        $this->record = $record;
        $this->url = route('nova.pages.detail', [
            'resource' => \App\Nova\Records\Combat::uriKey(),
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ->subject('New Combat Record Added')
    ...
    public function toNova()
    {
        return (new NovaNotification())
            ->message('A new combat record has been added to your personnel file.')
