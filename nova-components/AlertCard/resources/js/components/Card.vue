<template>
  <div
    v-if="props?.card?.subscription || props?.card?.messages?.length || props?.card?.announcements?.length"
        ...
        <div class="ac-flex">
          ...
          <div class="ac-ml-3 ac-flex-1 md:ac-flex md:ac-justify-between">
            ...
            <p class="ac-mt-3 ac-text-sm md:ac-mt-0 md:ac-ml-6" v-if="props.card.subscription.url || props.card.subscription.button">
              <a :href="props.card.subscription.url" class="ac-whitespace-nowrap ac-font-semibold ac-text-blue-700 hover:ac-text-blue-600">
        ...
        <div class="ac-flex">
          ...
          <div class="ac-ml-3 ac-flex-1 md:ac-flex md:ac-justify-between md:ac-items-center">
            ...
            <p class="ac-mt-3 ac-text-sm md:ac-mt-0 md:ac-ml-6" v-if="message.url || message.button">
              <a :href="message.url" class="ac-whitespace-nowrap ac-font-semibold ac-text-blue-700 hover:ac-text-blue-600">
                {{ message.button }}
                <span aria-hidden="true"> →</span>
              </a>
            </p>
