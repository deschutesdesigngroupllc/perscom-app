<template>
  <div class="dashboard-actions-flex dashboard-actions-justify-center">
    <div class="dashboard-actions-w-full">
      ...
      <p class="text-90 dashboard-actions-leading-tight">Providing cutting-edge personnel management for para-military organizations</p>
      ...
      <Card class="dashboard-actions-mt-4 dashboard-actions-rounded-lg" v-if="numberOfUserRoutes?.value > 0">
        <div class="md:dashboard-actions-grid md:dashboard-actions-grid-cols-2">
          <div
            v-for="(route, key, index) in routes.value.user"
            :key="index"
            ...
            :class="{
              'odd:md:dashboard-actions-border-r': numberOfUserRoutes.value > 1,
              'dashboard-actions-border-b': index < numberOfUserRoutes.value - 1,
              'md:dashboard-actions-border-b-0': index === numberOfUserRoutes.value - 2
            }"
          >
