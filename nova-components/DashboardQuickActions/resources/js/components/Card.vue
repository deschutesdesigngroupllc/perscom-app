<template>
    <div class="dashboard-actions-flex dashboard-actions-justify-center">
        <div class="dashboard-actions-w-full">
            <Heading>PERSCOM Personnel Management System</Heading>
            <p class="text-90 dashboard-actions-leading-tight">
                Providing cutting-edge personnel management for para-military organizations
            </p>

            <Card class="dashboard-actions-mt-4 dashboard-actions-rounded-lg" v-if="numberOfUserRoutes?.value > 0">
                        ...
                        <a :href="route.link"
                           class="dashboard-actions-no-underline dashboard-actions-flex dashboard-actions-p-6">
                            <div
                                ...
                                <svg class="text-primary-500 dark:text-primary-600" xmlns="http://www.w3.org/2000/svg"
                                     width="50" height="50" fill="none" viewBox="0 0 22 22" stroke="currentColor"
                                     stroke-width="1.2">
            ...
            <div class="dashboard-actions-mt-6" v-if="numberOfAdminRoutes?.value > 0">
                ...
                <p class="text-90 dashboard-actions-leading-tight">
                    Perform most common tasks in PERSCOM
                </p>

                <Card class="dashboard-actions-mt-4 dashboard-actions-rounded-lg">
                    <div class="md:dashboard-actions-grid md:dashboard-actions-grid-cols-2">
                        <div v-for="(route, key, index) in routes.value.admin" :key="index"
                             class="dashboard-actions-flex dashboard-actions-items-center dashboard-actions-border-gray-200 dark:dashboard-actions-border-gray-700"
                            ...
                            <a :href="route.link"
                               class="dashboard-actions-no-underline dashboard-actions-flex dashboard-actions-p-6">
                                <div
                                    class="dashboard-actions-flex dashboard-actions-justify-center dashboard-actions-items-center dashboard-actions-w-10 dashboard-actions-flex-shrink-0 dashboard-actions-mr-6">
                                    <svg class="text-primary-500 dark:text-primary-600"
                                         xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="none"
                                         viewBox="0 0 22 22" stroke="currentColor" stroke-width="1.2">
                                        <path stroke-linecap="round" stroke-linejoin="round" :d="route.icon"/>
                                    </svg>
                                </div>
