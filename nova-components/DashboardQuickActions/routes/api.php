...
Route::get('/routes', function (Request $request) {
    ...
    if (Gate::check('create', \App\Models\CombatRecord::class)) {
        $routes['combat'] = [
            ...
            'description' => 'Similar to Service Records, Combat Records provide a timeline of all combat encounters by the user.',
            'icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
        ];
    }

    if (Gate::check('create', \App\Models\QualificationRecord::class)) {
        $routes['qualification'] = [
            'link' => \route('nova.pages.create', [
                'resource' => QualificationRecord::uriKey(),
            ]),
            'title' => 'Create A New Qualification Record',
            'description' => 'Qualification records provide a way to track proficiency in personnel skills and abilities.',
    ...
    if (Gate::check('create', \App\Models\ServiceRecord::class)) {
        $routes['service'] = [
            ...
            'description' => 'Service records provide a written history of every action and event that happens to a user. Records can be manually generated or automated through common actions.',
            'icon' => 'M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
        ];
    }
