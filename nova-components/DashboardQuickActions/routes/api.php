...
Route::get('/routes', function (Request $request) {
    ...
    $routes['user']['formsubmission'] = [
        'link' => \route('nova.pages.create', 'submissions'),
    ...
    if (Gate::check('create:user')) {
        $routes['admin']['user'] = [
            'link' => \route('nova.pages.create', 'users'),
    ...
    if (Gate::check('create:assignmentrecord')) {
        $routes['admin']['assignment'] = [
            'link' => \route('nova.pages.create', 'assignment-records'),
    ...
    if (Gate::check('create:servicerecord')) {
        $routes['admin']['service'] = [
            'link' => \route('nova.pages.create', 'service-records'),
    ...
    if (Gate::check('create:combatrecord')) {
        $routes['admin']['combat'] = [
            'link' => \route('nova.pages.create', 'combat-records'),
    ...
    if (Gate::check('create:rankrecord')) {
        $routes['admin']['rank'] = [
            'link' => \route('nova.pages.create', 'rank-records'),
    ...
    if (Gate::check('create:awardrecord')) {
        $routes['admin']['award'] = [
            'link' => \route('nova.pages.create', 'award-records'),
