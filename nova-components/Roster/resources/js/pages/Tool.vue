...
<!--              </thead>-->
<!--              <tbody>-->
<!--                <tr class="roster-group" v-for="user in unit.users" v-if="unit.users.length > 0" :key="user.id" @click="goToProfile(user.url)">-->
<!--                  <td class="roster-w-1/12 roster-ml-2 roster-px-2 roster-py-2 roster-whitespace-nowrap roster-cursor-pointer dark:roster-bg-gray-800 group-hover:bg-gray-50 dark:group-hover:bg-gray-900">-->
...
<!--                    </div>-->
<!--                  </td>-->
<!--                  <td class="roster-w-1/12 roster-mr-2 roster-px-2 roster-py-2 roster-whitespace-nowrap roster-cursor-pointer dark:roster-bg-gray-800 group-hover:bg-gray-50 dark:group-hover:bg-gray-900">-->
