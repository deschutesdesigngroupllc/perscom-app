                ...
                <LoadingView :loading="loading.value">
                    <div class="roster-overflow-hidden roster-shadow roster-rounded-md">
                        ...
                        <ul role="list" class="roster-divide-y roster-divide-gray-200 dark:roster-divide-gray-700">
                            <li v-for="user in unit.users" v-if="unit.users.length > 0" :key="user.id"
                                @click="goToProfile(user.url)">
                                <a href="#" class="roster-block hover:roster-bg-gray-50 dark:hover:roster-bg-gray-700">
                                    <div
                                        ...
                                        <div class="roster-flex-grow-0">
                                            <img class="roster-h-10" :src="user.rank.image_url"
                                                 v-if="user.rank?.image_url">
                                            <span class="roster-whitespace-nowrap roster-font-bold"
                                        ...
                                        <div class="roster-flex-auto">
                                            ...
                                            <div class="roster-mt-2 sm:roster-flex sm:roster-justify-between">
                                                <div class="sm:roster-flex">
                                                    ...
                                                    <p v-if="user.specialty?.name"
                                                       class="roster-mt-2 roster-flex roster-items-center roster-text-sm roster-text-gray-500 sm:roster-mt-0 sm:roster-ml-6">
                                                        <svg
                                                            class="roster-mr-1.5 roster-h-5 roster-w-5 roster-flex-shrink-0 roster-text-gray-400"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                            fill="currentColor" aria-hidden="true">
                                                        ...
                                                        {{ user.specialty.name }}<span
                                                        v-if="user.specialty?.abbreviation">, {{
                                                            user.specialty.abbreviation
                                                        }}</span>
                                                    </p>
                                                </div>
                                                <div
                                                    class="roster-mt-2 roster-flex roster-items-center roster-text-sm roster-text-gray-500 sm:roster-mt-0">
                                                    <svg
                                                        class="roster-mr-1.5 roster-h-5 roster-w-5 roster-flex-shrink-0 roster-text-gray-400"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                        fill="currentColor" aria-hidden="true">
