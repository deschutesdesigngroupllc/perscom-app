...
return [
    ...
    */
    ...
    'prompts' => [
        'assignmentrecord' => [
            'created' => [
                'headline' => 'Generate a headline about a new assignment record being added to {user} personnel file. Use the following text, unit name, unit description, position name, position description, specialty name, specialty description and status from the assignment record for assistance. Assignment Record Text: "{text}" Unit Name: "{unit}" Unit Description: "{unit_description}" Position Name: "{position}" Position Description: "{position_description}" Specialty Name: "{specialty}" Specialty Description: "{specialty_description}" Status: "{status}"',
